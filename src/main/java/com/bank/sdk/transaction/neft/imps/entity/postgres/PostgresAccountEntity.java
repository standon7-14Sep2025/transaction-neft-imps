...
@Entity
@Table(name = "ACCOUNT")
public class PostgresAccountEntity {
...
/*    @Column(name = "CUSTOMER_ID", insertable = false, nullable = false)
    ...
    */
    ...
    private PostgresCustomerEntity customer;

    public PostgresCustomerEntity getCustomer() {
        return customer;
    }

    public void setCustomer(PostgresCustomerEntity customer) {
